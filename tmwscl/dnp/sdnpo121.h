 ...
 *   DNP SLAVE functionality for Object 121 Security Statistics
 *  
 */
#ifndef SDNPO121_DEFINED
#define SDNPO121_DEFINED
...
extern "C" {
  ...
  /* function: sdnpo021_assignClass
   * purpose: process assign class request for Security Statistics
   * arguments:
   *  pSession - session we are responding to
   *  pObjHeader - object header we are processing
