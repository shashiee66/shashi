 ...
 *   DNP SLAVE functionality for Object 10 Binary Output Status.
 */
#ifndef SDNPO010_DEFINED
#define SDNPO010_DEFINED
...
extern "C" {
  ...
  * purpose: write data to binary output points
  * arguments:
  *  pSession - session we are responding to
  *  pResponse - pointer to response message info
  *  pObjHeader - object header we are processing
  * returns:
  *   TMWDEFS_TRUE if writes to all points specified were successful
  *   TMWDEFS_FALSE if any writes failed
  */
